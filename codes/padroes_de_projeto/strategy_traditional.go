...
func (item LineItem) String() string {
	return fmt.Sprintf("<LineItem product:%s quantity:%d price:%.2f>",
...
// Discount is the method that should be implemented by the
// concrete implementation of a promotion
